...
const productSchema = z.object({
    ...
    message: "Sale start and end dates are required and must be valid when the product is on sale.",
        ...
        mutationFn: async (formData: ProductFormData) => {
            try {
                ...
                if (apiError.code === 11000) {
                    throw new Error('A product with this title already exists. Please choose a different title.')
                }
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    ...
                                    <div className="flex gap-6 items-center">
                                        <FormCheckbox
                                            ...
                                            onChange={e => handleFieldChange('isOnSale', e.target.checked)}
                                        />
                                        <FormCheckbox
                                            label="New Item"
                                            name="isNewItem"
                                            checked={data.isNewItem}
                                            onChange={e => handleFieldChange('isNewItem', e.target.checked)}
                                        />
                                        <FormCheckbox
                                            label="Best Seller"
                                            name="isBestSeller"
                            ...
                            <section>
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    <FormDateTimeInput
                                        ...
                                        onChange={value => handleFieldChange('salesStartAt', value)}
                                    />
                                    <FormDateTimeInput
                                        label="Sale End"
                        ...
                        <section>
                            ...
                            <div className="space-y-6">
                                <FormColors
                                    colors={data.colors}
                                    onAddColor={color => handleFieldChange('colors', [...data.colors, color])}
                                    onDeleteColor={index => {
                                ...
                                <FormDynamicList
                                    label="Models"
                                    items={data.models}
                                    onAddItem={() => handleFieldChange('models', [...data.models, ''])}
                                    onDeleteItem={index => {
                                ...
                                <FormDynamicList
                                    label="Features"
                                    items={data.features}
                                    onAddItem={() => handleFieldChange('features', [...data.features, ''])}
                                    onDeleteItem={index => {
                                ...
                                <FormDynamicList
                                    ...
                                    onAddItem={() => handleFieldChange('materials', [...data.materials, ''])}
                                    onDeleteItem={index => {
                                ...
                                <FormDynamicList
                                    label="Details"
                                    items={data.details}
                                    onAddItem={() => handleFieldChange('details', [...data.details, ''])}
                                    onDeleteItem={index => {
