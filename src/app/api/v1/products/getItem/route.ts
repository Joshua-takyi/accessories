...
/**
 * Handles GET requests for product listing with filtering, sorting, and pagination.
 * @param req - The incoming request object.
 * @returns A JSON response containing paginated products and metadata.
 */
export async function GET(req: NextRequest) {
	try {
		...
		const sortStage = BuildSort({ sortBy, sortOrder }) as Record<
			string,
			1 | -1
		>;
